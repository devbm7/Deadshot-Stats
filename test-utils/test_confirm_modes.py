...
def test_confirm_modes():
    ...
    if player1_stats:
        print(
            f"✅ Player1 stats - Total Tags: {player1_stats['total_tags']}, Best Match Tags: {player1_stats['best_match_tags']}"
        )
    else:
    ...
    if player2_stats:
        print(
            f"✅ Player2 stats - Total Tags: {player2_stats['total_tags']}, Best Match Tags: {player2_stats['best_match_tags']}"
        )
    else:
    ...
    player1_wins, player1_losses, player1_win_rate = calculate_player_wins(
        df, "Player1"
    )
    player2_wins, player2_losses, player2_win_rate = calculate_player_wins(
        df, "Player2"
    )

    print(
        f"Player1: {player1_wins} wins, {player1_losses} losses, {player1_win_rate}% win rate"
    )
    print(
        f"Player2: {player2_wins} wins, {player2_losses} losses, {player2_win_rate}% win rate"
    )
    ...
    player3_wins, player3_losses, player3_win_rate = calculate_player_wins(
        df, "Player3"
    )

    print(
        f"Player1 (Team1): {player1_wins} wins, {player1_losses} losses, {player1_win_rate}% win rate"
    )
    print(
        f"Player3 (Team2): {player3_wins} wins, {player3_losses} losses, {player3_win_rate}% win rate"
    )
